...
exports.getSkill = exports.allSkills = exports.Skills = void 0;
var nexus_1 = require("nexus");
var prismaError_1 = require("../prismaError");
var client_1 = require("@prisma/client");
var prisma = new client_1.PrismaClient();
exports.Skills = (0, nexus_1.objectType)({
    name: "Skills",
...
exports.allSkills = (0, nexus_1.extendType)({
    type: "Query",
    definition: function (t) {
        t.list.field("skills", {
            type: "Skills",
            resolve: function (_root, args) {
                return __awaiter(this, void 0, void 0, function () {
                    return __generator(this, function (_a) {
                        switch (_a.label) {
                            case 0: return [4 /*yield*/, prisma.skills.findMany({
                                    include: {
                                        categories: {
                                            include: {
                                                skill: true,
...
exports.getSkill = (0, nexus_1.extendType)({
    type: "Query",
    definition: function (t) {
        t.field("skill", {
            type: "Skills",
            ...
            resolve: function (_root, args) {
                return __awaiter(this, void 0, void 0, function () {
                    return __generator(this, function (_a) {
                        switch (_a.label) {
                            case 0: return [4 /*yield*/, prisma.skills
                                    .findUniqueOrThrow({
                                    where: {
                                        id: args.id
                                    }
